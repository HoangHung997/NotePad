...
> **HISTORICAL / SUPERSEDED FUTURE-DESIGN DRAFT**
>
> Retained as design evidence only. `docs/H2_PRODUCT_MASTER_SPEC.md` and `docs/H2_PRODUCT_MASTER_TASKS.md` are the current future-product authority. The independent non-AI defect/data-integrity authority remains `docs/H2_NOTES_NON_AI_BUG_LEDGER.md`.
