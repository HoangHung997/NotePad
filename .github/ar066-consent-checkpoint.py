...
CODE = '2f2dda5f6207f948ed56e30ca5cd2c50cb811948'
...
evidence={'task':'AR-066','scope':'Exact-bound live input plus separately approved disk reference/output/replacement/reselection; not a general multi-live resolver',
 ...
 'old_source_control':validation['old_source_control'],'historical_failure':failure,
...
handoff['historical_failure_notes_retained'].append(failure)
