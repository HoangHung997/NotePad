...
public static class Program
{
    ...
    public static int Main(string[] args)
    {
        ...
        if (args.Contains("--mb-agent-public-integration-boundary-test")) return H2AgentLab.Acceptance.MbAgentPublicIntegrationBoundaryTests.Run(args[^1]).GetAwaiter().GetResult();
