...
public sealed class ChatMessageView : Border
{
    ...
    public ChatMessageView(AiMessage message)
    {
        ...
        _thinking = new Expander { Name = "MessageThinking", Header = "Đang suy nghĩ…", FontSize = 12,
            HorizontalAlignment = HorizontalAlignment.Stretch,
            Content = _thinkingScroll };
        ...
        ToolTip.SetTip(_thinking, "Xem tiến trình do model cung cấp. Tự ẩn khi có câu trả lời; không lưu vào lịch sử.");
        Child = new StackPanel { Spacing = 6, Children = { title, _thinking, Body, _error, Actions, _time } };
        SetThinking("");
        Refresh();
    }
    ...
    public void Refresh()
    {
        ...
        Body.IsVisible = Message.Content.Length > 0;
