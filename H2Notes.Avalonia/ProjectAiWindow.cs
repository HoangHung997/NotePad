...
public sealed class ProjectAiWindow : Window
{
    ...
    public ProjectAiWindow(App app, MainWindow main, ProjectAiWindowState placement)
    {
        ...
        Title = "H2 Notes · AI dự án"; Icon = app.Icon; MinWidth = 340; MinHeight = 420; Topmost = placement.IsPinned;
        ...
        var title = new TextBlock { Text = "AI dự án", FontSize = 15, FontWeight = FontWeight.SemiBold, VerticalAlignment = VerticalAlignment.Center };
        ...
        var dock = AppIcon.Button(IconKind.Dock, "Ghép AI về bảng dự án"); dock.Name = "DockProjectAiButton";
        dock.Click += (_, _) =>
        {
        ...
        var pin = AppIcon.Button(Topmost ? IconKind.PinFilled : IconKind.Pin, "Ghim AI trên màn hình"); pin.Name = "PinChatButton";
        ...
        var close = AppIcon.Button(IconKind.Close, "Ẩn AI, giữ lịch sử dự án"); close.Name = "CloseButton"; close.Click += (_, _) => Close(); Add(close, 5);
        ...
        ToolTip.SetTip(picker, "Đổi dự án · dùng chung hội thoại và bản nháp với bảng dự án");
        picker.Click += (_, _) =>
        {
            var menu = new ContextMenu();
    ...
    internal void UpdateProject(ProjectRecord? project)
    {
        ...
        ToolTip.SetTip(_projectTitle, _projectTitle.Text); Title = "H2 Notes · AI · " + (project?.DisplayName ?? "Chọn dự án");
    }
